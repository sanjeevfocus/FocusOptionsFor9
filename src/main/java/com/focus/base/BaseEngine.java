	...
	//private String xlfile="\\E:\\ZFocusAI\\TestData.xls";
	  ...
	  public static Logger getLogger()
	  {
	   ...
	   public static String getTextByJs(WebElement element) { // for only getText (Individual text only)
		...
		public static DateTimeFormatter CurrentTime() {
		...
		public static void killChromedriver(WebElement element) 
		{
			try {
		...
		executor.executeScript("arguments[0].setAttribute('style' , 'background: light-yelow; border: 3px solid red;');", element);
		executor.executeScript("arguments[0].setAttribute('style' , 'background: light-yelow; border: 1px solid white;');", element);		
		...
		public void scrollPageDown(WebDriver getDriver) 
		{
		...
		public void scrollPageUp(WebDriver getDriver) 
		{
