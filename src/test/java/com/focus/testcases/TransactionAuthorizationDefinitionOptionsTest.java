...
public class TransactionAuthorizationDefinitionOptionsTest extends BaseEngine
{
	 ...
	 public void checkLogin() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, AWTException
	 {
		 ...
		 Assert.assertEquals(tadop.checkLogin(), true);
	 }
	 ...
	 @Test(priority=2242)
	 public void checkTransactionAuthotizationReport() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	 {
		 tadop=new TransactionAuthorizationDefinitionOptionsPage(getDriver());
	 ...
	 @Test(priority=2244)
	 public void checkCreateEmailHeaderTemplate() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	 {
		 tadop=new TransactionAuthorizationDefinitionOptionsPage(getDriver());
	 ...
	 @Test(priority=2245)
	 public void checkCreateEmailTemplate() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	 {
		 tadop=new TransactionAuthorizationDefinitionOptionsPage(getDriver());
		 Assert.assertEquals(tadop.checkCreateEmailTemplate(), true);
	 }	 
	 @Test(priority=2246)
	 public void checkPrintCreatedEmailTemplateAndValidatePdf() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, AWTException
	 {
		 tadop=new TransactionAuthorizationDefinitionOptionsPage(getDriver());
	 ...
	 @Test(priority=2247)
	 public void checkCreateSmsTemplate() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	 {
		 tadop=new TransactionAuthorizationDefinitionOptionsPage(getDriver());
	 ...
	 @Test(priority=2248)
	 public void checkCreateAlerts() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	 {
		 tadop=new TransactionAuthorizationDefinitionOptionsPage(getDriver());
	 ...
	 @Test(priority=2249)
	 public void checkSavingPurchaseVoucherNAlertTemplateTransactionAuthorization() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	 {
		 tadop=new TransactionAuthorizationDefinitionOptionsPage(getDriver());
	 ...
	 @Test(priority=2250)
	 public void checkAuthorizationStatusInVoucherHomePageCreateAlertOption() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	 {
		 tadop=new TransactionAuthorizationDefinitionOptionsPage(getDriver());
	 ...
	 @Test(priority=2251)
	 public void checkLogoutAndLoginWithUserAllOptionsWithCreateAlertOption() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	 {
		 tadop=new TransactionAuthorizationDefinitionOptionsPage(getDriver());
	 ...
	 @Test(priority=2252)
	 public void checkPurchasesVoucherNAuthorizationStatusWithUserAllOptionsAndAlertTemplateTransactionAuthorization() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	 {
		 tadop=new TransactionAuthorizationDefinitionOptionsPage(getDriver());
		 Assert.assertEquals(tadop.checkPurchasesVoucherNAuthorizationStatusWithUserAllOptionsAndAlertTemplateTransactionAuthorization(), true);
	 }
	 
	 @Test(priority=2253)
	 public void checkLogoutAndLoginWithSUToCheckAuthorizationStatusWithAlertTemplateTransactionAuthorization() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	 {
		 tadop=new TransactionAuthorizationDefinitionOptionsPage(getDriver());
		 Assert.assertEquals(tadop.checkLogoutAndLoginWithSUToCheckAuthorizationStatusWithAlertTemplateTransactionAuthorization(), true);
	 }
